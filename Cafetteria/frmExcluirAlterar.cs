...
namespace Cafetteria
{
    public partial class frmExcluirAlterar : Form
    {
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            try
            {
                String sql = @"update caf.Funcionarios set  CPF = @CPF,nm_func = @nome,end_func = @endereco, cont_func = @contato, cargo_func = @cargo ,sal_func = @salario)";
            ...
            try
            {
                String sql = @"update caf.Login set  senha = @senha, CPF = @CPF";
